...
describe('postsInChannel', () => {
    ...
    describe('receiving a page of posts in the channel', () => {
        ...
        it('should do nothing when the page is not 0', () => {
            const state = deepFreeze({
